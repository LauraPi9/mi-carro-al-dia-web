/*
 * Íconos SVG (trazos basados en Lucide, licencia ISC).
 * Uso en HTML: <span class="icon" data-icon="mail"></span>
 * Se insertan con JavaScript para no repetir el SVG en cada página
 * y para que funcione abriendo los archivos directamente (sin servidor).
 */
const ICONS = {
